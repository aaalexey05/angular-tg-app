...
const products: IProduct[] = [
  {
    ...
    text: 'Основные типы, компиляторы, классы, generic, утилиты, декораторы, advanced ...',
  ...
  },
  {
    ...
    text: 'BLD, история версий, ветвление, удаленный репозиторий, релизы, opensource...',
    time: 'С опытом 2 недели',
    type: ProductType.Skill,
  },
  {
  ...
  },
  {
    ...
    text: 'HTML, работа с текстом, списки, таблицы, форма, CSS, работа с цветом...',
    time: 'С нуля 2 недели',
    type: ProductType.Course,
  },
  {
